...
RedactContentRequest = _reflection.GeneratedProtocolMessageType('RedactContentRequest', (_message.Message,), dict(
  ...
  Attributes:
      info_type:
          ...
          redacts all text that it matches against all info\_types that
      ...
      redact_all_text:
          If true, all text found in the image, regardless if it matches
          an info\_type, is redacted.
      redaction_color:
...
CreateInspectOperationRequest = _reflection.GeneratedProtocolMessageType('CreateInspectOperationRequest', (_message.Message,), dict(
  ...
  Attributes:
      ...
      output_config:
          ...
          time\_stamp  .. raw:: html     <p>  For Cloud Storage the next
