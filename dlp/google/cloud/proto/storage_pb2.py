...
InfoType = _reflection.GeneratedProtocolMessageType('InfoType', (_message.Message,), dict(
  ...
  Attributes:
      name:
          Name of the information type. For built-in info types, this is
          provided by the API call ListInfoTypes. For user-defined info
          types, this is provided by the user. All user-defined info
          types must have unique names, and cannot conflict with built-
          in info type names.
  """,
